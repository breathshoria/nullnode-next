...
const Project: NextPage<Props> = ({ project }) => {
  return (
    <>
      <div
        className={
          "min-h-screen p-5 w-full flex flex-col gap-4 items-center mx-auto"
        }
      >
        <PageHead title={project.title} />
        <div
          className={
            "w-1/2 p-2 flex flex-col justify-evenly gap-1 sm:gap-0 sm:flex-row items-center border-b-2 rounded-b-sm border-b-sky-700"
          }
        >
          <img
          ...
          <div
            className={
              "flex flex-col items-center gap-2 p-1 font-medium text-lg text-black sm:text-base"
            }
          >
            ...
            <div
              className={
                "bg-white rounded-md p-2 min-w-max flex flex-row gap-2"
              }
            >
              ...
              <a href={project.telegram}>
                <img className={"w-5"} src={"/telegram.svg"} alt={"tg logo"} />
              </a>
            </div>
          </div>
        </div>
        ...
        <div className={"mt-2 grid sm:grid-cols-2 gap-5 w-3/4"}>
          <div
            className={"border-sky-700 border-2 rounded-xl p-4 flex flex-col"}
          >
            <p
              className={
                "text-center font-medium text-lg bg-sky-700 mb-2 rounded-md"
              }
            >
              Summary
            </p>
          ...
          >
            ...
            <ReactMarkdown className={"prose prose-md prose-invert m-0"}>
              {project.involvement}
            </ReactMarkdown>
          </div>
        </div>
