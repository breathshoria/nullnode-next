...
const ProjectCard = ({id, title, onGoing, logoUrl, description}: Props) => {
    return (
        <Link
            href={`/projects/${id}`}
        >
            <div  className={`relative w-3/4 sm:w-full flex flex-col items-center justify-center bg-sky-700 hover:bg-sky-600 rounded-xl p-2 flex-nowrap min-h-full cursor-pointer`}>
